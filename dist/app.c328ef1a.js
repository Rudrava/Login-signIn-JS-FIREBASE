...
(function init() {
  ...
  var gSignIn = document.querySelector(".signInWithG"); // console.log(email, password, logIn, signIn)

  gSignIn.addEventListener('click', function (e) {
  ...
  logIn.addEventListener('click', function (e) {
    ...
    var auth = firebase.auth(); //signIn

    var signInPromise = auth.signInWithEmailAndPassword(mail, passwd);
  ...
  signIn.addEventListener('click', function (e) {
    ...
    var signInPromise = auth.createUserWithEmailAndPassword(mail, passwd);
    signInPromise.catch(function (e) {
      return console.log(e.message);
    });
  ...
  firebase.auth().onAuthStateChanged(function (firebaseUser) {
    if (firebaseUser) {
      console.log(firebaseUser.displayName); // logOut.classList.remove('hidden')
